...
/** Google Gemini — four-point sparkle with the brand gradient. */
    ...
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <defs>
        <linearGradient id="gemini-grad" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="1" stopColor="#D3608B" />
        </linearGradient>
      </defs>
      <path
        d="M12 1c.6 5.9 4.9 10.4 11 11-6.1.6-10.4 5.1-11 11-.6-5.9-4.9-10.4-11-11 6.1-.6 10.4-5.1 11-11Z"
...
/** Anthropic (Claude) — the "A" mark in Claude's coral. */
export function ClaudeIcon({ className }: BrandIconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="#D97757" aria-hidden>
...
/** OpenAI — the hexagonal knot mark. */
